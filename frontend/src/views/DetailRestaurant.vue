<template>
  <main>
    ...
    <div class="hero_in detail_page background-image" data-background="url(assets/img/ru-banner.jpg)">
                ...
                <div id="collapse-A" class="collapse" role="tabpanel" aria-labelledby="heading-A">
                  <div class="card-body info_content">
                    ...
                    <div class="pictures magnific-gallery clearfix">
                      <figure><a href="assets/img/detail_gallery/detail_1.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src="assets/img/thumb_detail_placeholder.jpg" data-src="assets/img/thumb_detail_1.jpg" class="lazy" alt=""></a></figure>
                      <figure><a href="assets/img/detail_gallery/detail_2.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src="assets/img/thumb_detail_placeholder.jpg" data-src="assets/img/thumb_detail_2.jpg" class="lazy" alt=""></a></figure>
                      <figure><a href="assets/img/detail_gallery/detail_3.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src="assets/img/thumb_detail_placeholder.jpg" data-src="assets/img/thumb_detail_3.jpg" class="lazy" alt=""></a></figure>
                      <figure><a href="assets/img/detail_gallery/detail_4.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src="assets/img/thumb_detail_placeholder.jpg" data-src="assets/img/thumb_detail_4.jpg" class="lazy" alt=""></a></figure>
                      <figure><a href="assets/img/detail_gallery/detail_5.jpg" title="Photo title" data-effect="mfp-zoom-in"><span class="d-flex align-items-center justify-content-center">+10</span><img src="assets/img/thumb_detail_placeholder.jpg" data-src="assets/img/thumb_detail_5.jpg" class="lazy" alt=""></a></figure>
                    </div>
                    <!-- /pictures -->
...
export default {
  ...
  methods: {
    settings() {
      ...
      // Read more
      window.$(".content_more").hide();
      window.$(".show_hide").on("click", function () {
        var txt = window.$(".content_more").is(':visible') ? 'Read More' : 'Read Less';
        window.$(this).text(txt);
        window.$(this).prev('.content_more').slideToggle(200);
      });

      // Time and people select
      window.$('.radio_select input[type="radio"]').on("click", function () {
        var value = window.$("input[name='time']:checked").val();
        window.$('#selected_time').text(value);
      });

      window.$('.radio_select input[type="radio"]').on("click", function (){
        var value = window.$("input[name='people']:checked").val();
        window.$('#selected_people').text(value);
      });

      window.$('.radio_select input[type="radio"]').on("click", function (){
        var value = window.$("input[name='day']:checked").val();
        window.$('#selected_day').text(value);
      });
...
// Image popups
      ...
      window.$('.btn_reserve_fixed a').on('click', function() {
        window.$(".box_booking").show();
      });
      window.$(".close_panel_mobile").on('click', function (event){
        event.stopPropagation();
        window.$(".box_booking").hide();
      });

      // Accordion

      window.$('.accordion_2').on('hidden.bs.collapse shown.bs.collapse', this.toggleChevron);
